Thumbor AWS
===========
Based on https://github.com/willtrking/thumbor_aws to fit the new thumbor release and european aws created buckets
...
Additional Configuration values used:
    ...
    # AWS host help restrict the a specific host to work around the boto encryption error related to newly buckets created in europe
